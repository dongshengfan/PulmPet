import { boxBottom } from '../boxes/boxHorizontalBottom';
/**
...
var FactoryAnimalPrefab = cc.Class({
    ...
    properties: {
        _box:boxBottom,//бокс в котором осуществляется работа          
        ...
        content:cc.String,//имя нода куда повесить новоиспеченое животное
